  ...
  return (
    ...
    <div className="flex-container fade-in">
      ...
      <div className="f-item navigation-container"> 
        <div>
          <button className="read-more" onClick={props.handleReadMore} > 
          <p> read more </p>
          </button>
        </div>
      
        <div>
          <button className="view-gallery" onClick={props.handleLandingPage} > 
          <p> View Gallery</p>
          </button>
        </div>
      </div>
      ...
      <div> 
        <a 
          className="lang" 
          onClick={props.toEng} > EN </a>
        | 
        <a 
          className="lang" 
          onClick={props.toEs}> ES </a>
      </div> 
      </div>
